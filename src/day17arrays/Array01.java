...
public class Array01 {
	...
	public static void main(String[] args) {
		...
		int a[]  = new int [5]; // Kac element oldugunu basta yazazagiz "5" gibi int array olusturmus olduk
		                        //ACIKLAMA: to create non primitive things we use"new"
	 //ACIKALAMa: int den sonra []' i istedigin yere koyabilirsin istersen a dan once sonra
		System.out.println(Arrays.toString(a));//[0, 0, 0, 0, 0] Arrays.toString(a) ile yaziyoruz
