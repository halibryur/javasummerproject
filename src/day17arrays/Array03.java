...
public class Array03 {
	...
	*/
	...
	public static void main(String[] args) {
		...
		int length = scanner.nextInt();	// integer container kurduk , nextint alip verilen rakami length koydu
		String s[] = new String[length]; // array kurduk uzunluk aldik int length den gelen

		System.out.println("Enter String array elements...");
		for(int i=0; i<length; i++) {		
			s[i] = scanner.next();
		}
		System.out.println(Arrays.toString(s));//Arrays.toString(a) ile yaziyoruz
