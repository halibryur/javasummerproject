...
public class MethodCreation01 {
	...
	/*
	 ...
	 Note: If you create method whose a) names are same, b)parameters are different c) in the same class, this called
	       "Method Overloading".
...
public static int add(int a, int b) {		// add method kurmus olduk main method un altinda, sonra  yukaridaki leri yazdik  yukarda coklu islem
	//yapmamiza firsat tanimasi islevselliginin onemini gosteriyor
		
		return a + b;		
	}
	//1)Make data types of parameters different
...
public static int add(short t, int u) {
	...
	public static int add(int t, short u) {
		return t  + u +4;
	}
