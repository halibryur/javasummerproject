...
public class PassByValue {
	...
	/*
	 	...
	 	2)If you insist to update original value, you can do it by assigning method return to the variable like;
	 	  a = increase(a);
	 	  ACIKLAMA :Immutable : can't be changeable
		             Mutable: Updateable  birde burada primitive i ele alarak yaptik
		             orjinal degerin sabit kalmasi icin assignment yapmamali zaten
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	a = increase(a);
	   */
		int a = 10;		// assignment yapilmadigi icin 10 da kaldi
		...
		*/
		...
		List<String> list1 = List.copyOf(list); // copyOf method ile orjinal degeri en basta ki gibi degismeden kullanirz
		
		System.out.println("Before method call: " + list);//
		
		putExclamationMark(list);// assignment yapilmasada List ozelliigi isletir yukaridan fakli olarak
