...
public class Lists01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(l3c); //[2, 5, 3, 1]
...
//		System.out.println(l3c);
        ...
        System.out.println(l3c.contains(3));//true
		
		l3c.set(1, 15);
		System.out.println(l3c);//[2, 15, 3, 1] 1.siradaki elementi 15 le degistirmeye izin var
		...
		System.out.println(list);//[12, 15, 11, 8] LIST listesi
		...
		Integer arr[] = list.toArray(new Integer[0]); // burada new ve [0] sabit degismez
		
		System.out.println(Arrays.toString(arr));//[12, 15, 11, 8] ARRAY liste ile ayni
