...
public class Question02 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		char initial = scanner.next().charAt(0); // Ali Can icin ==> next(); dersek "Ali" alinir 
		// nextline();dersek Ali Can alinir yani tum satir
		if(initial>='A' &&       initial<='Z') {
				// > ve > koymamiz ASCII table da ki A....Z arasi sinirlandirma 
			//sonra a...z burada kucuk a dan farki yakalamak icin	>='A' ile buyuk harfi bagliyoruz
			if(initial=='A') {			
