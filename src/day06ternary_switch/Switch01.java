...
public class Switch01 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 * ACIKLAMA:toLowerCase(); yazmamizin nedeni olurda user lowercace girerse j n gibi
		 case:senaryomuzu olusturmak icini kullanilir
		 break: orada kalsin daha ilerlemesin cevapsa diye yazilmis bir coddur
		 case den sonra:, break dan sonra ; () sonra ; unutma
		 Baska baska sacma seyler girmesin diye biten optionimiz sonuna default yazarsak sadece bizim yukariyi baz alacak
		 ORN: JULY olarak girersen case kismi calismaz cunku hepsini lower a cevirdik	
		 	else ve defaut ayni islevdeler
		 	
		 	Inside the switch() parenthesis, you can use String, char, byte, short, int
		 	But boolean ( use instead if  else ), long, float, and double 
		*/
