...
public class MethodOverLoading01 {
	...
	} // outside the main method oluyor burasi buraya kuruyoruz oonce  classicindyiz ama
	
	public static int add(int... a) { // varargs kullnadik 
		System.out.println("I am using varargs...");
		return 1;
	}
	
	public static double add(int a, int b)  { //data type default olarak Java int olarak atar ve ilk ona bakar 
