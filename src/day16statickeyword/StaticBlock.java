...
public class StaticBlock {
	...
	/*
	 	...
	 	static block: 1)It is used to initialize "class(static) variables"
	 	              2)static block is executed before everything(constructors, methods, main method) inside the class
	...
	*/
	...
	static {
		System.out.println("Static block 1");// static block sira disi olarak main method dan once console cikar
	}
